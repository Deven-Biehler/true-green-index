...
def main():
    '''
    Takes in park and sentinel data, creates a mask for the park area, 
    creates patches of the sentinel data and labels them based on whether 
    they contain park areas.
    '''
